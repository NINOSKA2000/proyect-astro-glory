...
import "./input-scroll-wheel.css";
import { applyStyle } from "./applyStyle";

class InputScrollWheel extends React.Component {
  constructor() {
    super();
    ...
    return this.props.data?.map((item, index) => {
      return index === 0 ? (
        <div
          ...
          style={{ minHeight: height + "px", maxHeight: height + "px", paddingLeft: height + "px", paddingRight: height + "px" }}
        >
          <div
            key={item}
  ...
  render() {
    ...
    return (
      <div>
        <p className="scroll-selector-title">DECADE</p>
        <div
...
export default InputScrollWheel;